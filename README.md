...
* Develop full-stack web applications using **JavaScript, TypeScript, React, Next.js, PHP, and Laravel**
* Build backend systems with **Java, Spring Boot, PostgreSQL, Redis, and Apache Kafka**
* Work with relational and NoSQL databases including **PostgreSQL, MySQL, MongoDB, and Firebase**
* Comfortable working with **Git, GitHub, Postman, Jira, Docker, and GitHub Actions CI/CD**
* Background in **UI/UX design**, with experience using Figma and Photoshop
